...
What information does a graph store?  
...
::: {.callout-tip title="Think"}
What information is easy to see in a graph visualization?  
...
::: {.callout-tip title="Think"}
Does the edge list contain different graph information from the
graph visualization?  
...
::: {.callout-tip title="Think"}
How is the same connection represented here?  
...
::: {.callout-tip title="Think"}
Is this different information from the graph visualization, edge
