...
Shared datasets live in `data/` at the repository root. Lab 1 notebooks import `data.loader`, which always looks there; `lab01_setup.py` puts the repo root on `sys.path` even when the working directory is `exercises/lab01/`.
